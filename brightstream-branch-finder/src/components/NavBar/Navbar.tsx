    ...
    <nav className="site-nav">
        <div className="mx-auto flex w-full max-w-[1700px] flex-wrap items-center justify-between gap-3 sm:gap-4">
          ...
          >
            ...
            <button className="ease-up mt-2 inline-flex h-11 min-w-[136px] cursor-pointer items-center justify-center whitespace-nowrap rounded-full border-none bg-[var(--gold)] px-8 text-[1.05rem] font-normal leading-none text-[var(--warm-white)] transition-[background-color,color,box-shadow] duration-300 ease-out hover:bg-[var(--warm-white)] hover:text-[var(--slate)] hover:shadow-[0_10px_18px_-8px_rgba(212,175,55,0.35)]">
              Get Started
            </button>
          </div>
        </div>
